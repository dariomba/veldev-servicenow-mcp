...
const catalogItem = require('./fixtures/sc_cat_item.json') as Record<
  string,
  unknown
>;
const variables = require('./fixtures/variables.json') as unknown[];
const uiPolicies = require('./fixtures/ui_policies.json') as unknown[];
const clientScripts = require('./fixtures/client_scripts.json') as unknown[];
const variableSets = require('./fixtures/variable_sets.json') as unknown[];
